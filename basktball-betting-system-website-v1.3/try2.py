        ...
        if(limit==7):
            ...
            if(home_team_winning_chances>away_team_winning_chances):
                ...
                if(points_home>points_away):
                    return [avg_home_chance,avg_away_chance,points_home[0][0],points_away[0][0]]
                else:
                    return [avg_home_chance,avg_away_chance,points_away[0][0],points_home[0][0]]
...
get_betting_results("Los Angeles Lakers","Los Angeles Clippers")